# open-slide review-animations (MIT)
# Source: https://github.com/.../open-slide (7.6k stars, MIT) — review-animations skill + STANDARDS.md
# Vendored rationale: the 'justified motion' review bar SKILL.md §8 enforces (why-is-this-animating as a blocking standard).
# Rule text in SKILL.md wins on any conflict.
